...
Ratifying THIS document authorizes **Stage 1 build only, zero model calls.** The live run requires a SEPARATE sanction of the exact hashed artifacts. No wiring, no `cam/` edit, no Gate B change, no dependency-map change, no post-review edit, no patent drafting. Wiring stays blocked behind Gates A–D (423 §8) and the two 430 blockers.
