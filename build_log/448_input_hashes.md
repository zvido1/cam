...
## REVISED-STEP ENTRY record (before revised analysis)

```
$ python build_log/448_hash_artifacts.py ENTRY-REVISED
```
...
## REVISED-STEP EXIT record (end of step)

```
$ python build_log/448_hash_artifacts.py EXIT-REVISED
```
